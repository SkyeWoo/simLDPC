function [vHat,Lrji] = decodeModMinSumLogDomain(rx, H, N0, iteration)
...
for n = 1:iteration
   ...
   for j = 1:N
      ...
      for k = 1:length(r1)        
         ...
         Lqij(r1(k), j) =gama*( Lci(j) + sum(Lrji(r1, j)) - Lrji(r1(k), j));
